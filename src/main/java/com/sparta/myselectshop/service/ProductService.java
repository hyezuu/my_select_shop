...
public class ProductService {
	...
	public void updateBySearch(Long id, ItemDto itemDto) {
		Product product = productRepository.findById(id)
			.orElseThrow(() -> new NullPointerException("해당하는 상품은 존재하지 않습니다."));
	...
	public void addFolder(Long productId, Long folderId, User user) {
		...
		Optional<ProductFolder> overlapFolder
	...
	public Page<ProductResponseDto> getProductsInFolder(Long folderId, int page, int size,
		...
		Page<ProductResponseDto> responseDtoListDto = productList.map(ProductResponseDto::new);

		return responseDtoListDto;
	}
}
